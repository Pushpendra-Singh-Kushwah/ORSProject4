		...
		<center>
			...
			<table>
				...
				<tr>
					...
					<td><%=HTMLUtility.getList("studentId", String.valueOf(bean.getStudentId()), l)%><td style="position: fixed;"><font
						color="red"> <%=ServletUtility.getErrorMessage("studentId", request)%></font></td></td>
				</tr>
				<tr>
